    ...
    <div style={page}>
      ...
      {result && (
        <>
          ...
          >
            <h3>
              If you used {money(monthlyAmount)}/month elsewhere
            </h3>
            ...
            >
              <div>
                <strong>Overpay loan</strong>
                <p style={{ color: "#475569", lineHeight: 1.7 }}>
                  May reduce interest and shorten repayment
                  if you are likely to repay in full.
                </p>
              </div>
              ...
              <div>
                ...
                <p style={{ color: "#475569", lineHeight: 1.7 }}>
                  Around <strong>{money(savingsValue)}</strong> in 5 years
                  using a simple 3% assumption.
                </p>
              </div>
              ...
              <div>
                ...
                <p style={{ color: "#475569", lineHeight: 1.7 }}>
                  Around <strong>{money(investingValue)}</strong> in 5 years
                  using a simple 5% growth assumption.
                </p>
              </div>
            </div>
                ...
                >
                  Illustrative examples only. Real returns and loan outcomes vary.
                </p>
              </div>
